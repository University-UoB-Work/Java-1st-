...
public class Server{ 
   ...
   static final String DRIVER = "com.mysql.jdbc.Driver"; // JDBC driver
     ...
     * Server Settings
     * 
     * DATABASE is a name of the database that contains data that you need
     * HOST is an IP or domain name of the Database
     * USERNAME and PASSWORD is user-name and password that will allow a user to connect to the Database
     * DATABASE_URL is used by all the methods that do any communication or data garbing with/from the Database
     */
	   ...
	   //registration in main
	          ...
	          //student on load              	  
	           ...
	           //staff on load             	  
	                  ...
	                  // String sent;
	                        	  //coresponding units - after changing status of the list ?
	                        		  ...
	                        		  ///there is no link between XD
	                               			...
	                               			//System.out.println(splitsMessage[2]+"this is what I get");
